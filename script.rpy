...
label back_garden_1:
    ...
    hide expression justine.get_image("normal") with dissolve
    show expression guard.get_image("annoyed") at right
    voice "audio/guard/line10.MP3"
    g "Talagang hindi na mau-ulit to"
    voice "audio/guard/line11.MP3"
